...
?>
						<tr>
							...
							<td><div style="text-align: center;"><a href="scriptcatedit.php?id=<?php echo $rowsCategories['id']; ?>"><i class="icon-edit <?php echo formatIcon('', TEMPLATE); ?>"></i></a></div></td>
							<td><div style="text-align: center;"><a href="#" onclick="doDelete('<?php echo $rowsCategories['id']; ?>', '<?php echo htmlspecialchars($rowsCategories['name']); ?>')"><i class="icon-remove <?php echo formatIcon('', TEMPLATE); ?>"></i></a></div></td>
						</tr>
<?php
}
