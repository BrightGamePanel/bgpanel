...
$numData = mysql_num_rows(mysql_query( "SELECT `timestamp` FROM `".DBPREFIX."boxData` WHERE `timestamp` >= '".(time() - (60 * 60 * 24 + CRONDELAY))."'" ));
if ($numData < 2)
{
	//Error: No Data or Insufficient Data (day_process)
