...
?>
			<div class="well">
				...
				<table id="scripts" class="tablesorter">
					<thead>
						<tr>
							<th>ID</th>
							<th>Name</th>
...
?>
						<tr>
							...
							<td><div style="text-align: center;"><a href="scriptprofile.php?id=<?php echo $rowsScripts['scriptid']; ?>"><i class="icon-edit <?php echo formatIcon('', TEMPLATE); ?>"></i></a></div></td>
							<td><div style="text-align: center;"><a href="scriptsummary.php?id=<?php echo $rowsScripts['scriptid']; ?>"><i class="icon-search <?php echo formatIcon('', TEMPLATE); ?>"></i></a></div></td>
						</tr>
<?php
