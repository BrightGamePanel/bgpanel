...
?>
					...
					<label><?php echo T_('IP - Box'); ?></label>
<?php
...
else
{
	...
	//---------------------------------------------------------+
?>
						<input class="input-xlarge disabled" type="text" disabled="" placeholder="<?php echo$serverIp['ip'].' - '.htmlspecialchars($boxes[$rows['boxid']], ENT_QUOTES); ?>">
