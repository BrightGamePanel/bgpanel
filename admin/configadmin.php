...
?>
			<div class="well">
				<div style="text-align: center; margin-bottom: 5px;">
					<span class="label label-info"><?php echo mysql_num_rows($admins); ?>&nbsp;<?php echo T_('Record(s) Found'); ?></span> (<a href="configadminadd.php"><?php echo T_('Add New Administrator'); ?></a>)
				</div>
