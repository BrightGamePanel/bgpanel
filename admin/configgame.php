...
?>
						<tr>
							...
							<td><?php echo htmlspecialchars($rowsGames['game']); ?></td>
							...
							<td><div style="text-align: center;"><a href="configgameedit.php?id=<?php echo $rowsGames['gameid']; ?>"><i class="icon-edit <?php echo formatIcon('', TEMPLATE); ?>"></i></a></div></td>
							<td><div style="text-align: center;"><a href="#" onclick="doDelete('<?php echo $rowsGames['gameid']; ?>', '<?php echo htmlspecialchars($rowsGames['game']); ?>')"><i class="icon-remove <?php echo formatIcon('', TEMPLATE); ?>"></i></a></div></td>
						</tr>
<?php
}
