...
?>
			<div class="row-fluid">
				...
				<div class="span6">
					<legend><?php echo T_('Your Group(s)'); ?></legend>
...
?>
			...
			<legend><?php echo T_('Assigned Game Server(s)'); ?></legend>
				<div style="text-align: center; margin-bottom: 5px;">
					<span class="label label-info"><?php if (!empty($servers)) { echo count($servers); } else { echo '0'; }  echo T_(' Server(s)'); ?></span>
				</div>
