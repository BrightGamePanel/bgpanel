...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
		...
		*/
		...
		VALUES
		  ...
		  ('9', 'Call of Duty 4: Modern Warfare', 'Active', '18', '28960', 'Server CFG File', 'server.cfg', 'fs_homepath', '/home/user/cod4', 'fs_basepath', '/home/user/cod4', '', '', '', '', '', '', '', '', '', '', '', '', './cod4_lnxded +exec {cfg1} +set sv_maxclients {slots} +map_rotate +set net_ip {ip} +set net_port {port} +set fs_homepath {cfg2} +set fs_basepath {cfg3} +set dedicated 2', 'callofduty4', '28960', '~/game-repositories/cod4/'),
		  ...
		  ('12', 'Call of Duty 2', 'Active', '32', '28960', 'Server CFG', 'server.cfg', 'fs_homepath', '/home/user/cod2', 'fs_basepath', '/home/user/cod2', '', '', '', '', '', '', '', '', '', '', '', '', './cod2_lnxded +exec {cfg1} +map_rotate +set net_ip {ip} +set net_port {port} +set fs_homepath {cfg2} +set fs_basepath {cfg3} +set dedicated 2', 'callofduty2', '28960', '~/game-repositories/cod2/'),
		  ...
		  ('14', 'Wolfenstein: Enemy Territory', 'Active', '32', '27960', 'Server CFG File', 'server.cfg', 'fs_homepath', '/home/user/wolfet', 'fs_basepath', '/home/user/wolfet', '', '', '', '', '', '', '', '', '', '', '', '', './etded +exec {cfg1} +sv_maxclients {slots} +set fs_homepath {cfg2} +set fs_basepath {cfg3} +set net_port {port}', 'wolfet', '27960', '~/game-repositories/wolfet/'),
		  ('15', 'ArmA: 2', 'Active', '64', '2302', 'Server CFG File', 'server.cfg', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', './server -config={cfg1} -netlog -port={port}', 'arma2', '2302', '~/game-repositories/arma2/'),
		  ...
		  ('18', 'ArmA: Armed Assault', 'Active', '64', '2302', 'Server CFG File', 'server.cfg', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', './server -config={cfg1} -netlog -port={port}', 'arma', '2302', '~/game-repositories/arma/'),
		  ('19', 'Battlefield 2', 'Active', '64', '16567', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', './start.sh', 'bf2', '29900', '~/game-repositories/bf2/'),
